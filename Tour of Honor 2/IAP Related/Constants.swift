...
let subscription_2 = "net.tommyc.iTOH.AnnualSub"
let shared_secret = "e0c5babf8e654fbb9573e1ac419ea4b5"

let terms_text = "A subscription is required to submit any of the optional auxilary bonuses, or to submit more than four state memorials. This subscription automatically renews with the price and duration given above unless it is canceled at least 24 hours before the end of the current period. Payment will be charged to your Apple ID account at the confirmation of purchase. Your account will be charged for renewal within 24 hours prior to the end of the current period. You can manage and cancel your subscriptions by going to your account settings on the App Store after purchase. Any unused portion of a free trial period, if offered, will be forfeited when the user purchases a subscription to that publication, where applicable."
